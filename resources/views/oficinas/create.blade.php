            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="/oficinas" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre" required class="w-full border rounded px-3 py-2 mt-1">
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700">Ubicación</label>
                        <input type="text" name="ubicacion" class="w-full border rounded px-3 py-2 mt-1">
                    </div>
